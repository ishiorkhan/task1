...
|
*/
$config['base_url'] = 'http://employee.loc/task1/';

// $config['base_url'] = 'http://task.az/';
...
|
| See http://php.net/htmlspecialchars for a list.php of supported charsets.
|
*/
...
|	array('q') = Enabled, but only take into account the specified list.php
|	             of query parameters.
|
*/
...
|
| You can use both an array or a comma-separated list.php of proxy addresses,
